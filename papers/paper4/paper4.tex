\ifmain
\section{Expanding Entropy and the Birth of Spacetime: \newline An Information-Theoretic Model of Cosmological Inflation}
...
This might align with observed cosmic evolution: inflation (early burst), structure formation, and degeneration during late-time
...
This model, despite its simplicity and lack of predictive power, reveals surprising regularities in the evolution of bitstring-based universes. One of the most striking is the emergence of a lognormal distribution in the frequency of structures near the entropy minimum. This distribution has a direct geometric interpretation: it implies that the singularity is not a point of physical breakdown, but of perfect informational smoothness. In such a regime, the entropy landscape offers no persistent structures—hence, no particles, no time evolution, no memory.
